...
SYSTEM_PROMPT = '''Ты дружелюбный англичанин-ассистент. Развивай тему и задавай вопрос в конце. Не пиши много текста'''
...
class GPT:
    ...
    data = {
        ...
        "completionOptions": {
            ...
            "maxTokens": "150"  # максимальное число сгенерированных токенов
        },
        "messages": [
            {
                "role": "system",
